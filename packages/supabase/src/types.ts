  ...
  public: {
    Tables: {
      ...
      dealer_invites: {
        ...
        Relationships: [
          {
            foreignKeyName: "dealer_invites_dealer_id_fkey"
            columns: ["dealer_id"]
            isOneToOne: false
      ...
      photo_sessions: {
        Row: {
          ...
          studio_processed_at: string | null
          updated_at: string
          user_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "photo_sessions_dealer_id_fkey"
            columns: ["dealer_id"]
            isOneToOne: false
            referencedRelation: "dealers"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      my_dealer: {
        ...
        Returns: {
          dealer_id: string
          display_name: string
          plate_overlay_path: string
          studio_background_path: string
          studio_monthly_limit: number
