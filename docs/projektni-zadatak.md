...
- **Sekcijska navigacija (AŽURIRANO 2026-08-24, ODLUČENO): Eksterijer · Interijer · Prtljažnik · Značajke i oprema · Mehanika** — peterodijelna shema zamjenjuje raniju trodijelnu (Eksterijer/Interijer/Detalji). "Mehanika" je opcionalna sekcija (za novije aute se motor/podvozje ne slika; za oldtimere i classice je must-have — app je aktivno predlaže kad VIN ukazuje na oldtimera). "Dokumenti" (servisna povijest, CarVertical PDF...) NISU fotografije — žive u `documents` tablici (sekcija 10). Vođeno fotografiranje: 16 standardnih kadrova u kružnom redoslijedu (fotograf hoda oko auta u jednom smjeru), naslovna fotografija je UVIJEK prednja lijeva dijagonala 45°. — diferencijator: fotografije dolaze iz vođenog fotografiranja (sekcija 4), pa sustav zna kategoriju svake slike → garantirano konzistentan redoslijed na svakom oglasu; kupac uči strukturu galerije nesvjesno. Nijedan oglasnik to nema jer nijedan ne kontrolira nastanak fotografija.
